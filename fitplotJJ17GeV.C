...
//setting the enviroment
  ...
  Int_t nbins=21;//128 previously
  Float_t low=15.5,high=19.5;
  ...
  //RooChebychev bkg("bkg","Background",mass,RooArgSet(a0,a1,a2,a3,a4));//original
